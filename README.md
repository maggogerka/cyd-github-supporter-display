...
- JPEG/PNG-аватары 96×96, HTTPS redirects, сигнатурная проверка и placeholder для GIF/ошибок;
- LittleFS-кэш аватаров с именами на основе numeric GitHub ID, лимитом 1,4 МБ и удалением устаревших файлов;
